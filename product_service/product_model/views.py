...
def get_all_product(req):
    url_book = 'http://127.0.0.1:3001/getbook'
    url_clothe = 'http://127.0.0.1:3002/getclothe'
    url_electronic = 'http://127.0.0.1:3003/getelectronic'
    url_shoe = 'http://127.0.0.1:3004/getshoe'
    ...
    response = requests.post(url_electronic, headers=headers)
    api_resp3 = json.loads(response.content.decode('utf-8'))

    response = requests.post(url_shoe, headers=headers)
    api_resp4 = json.loads(response.content.decode('utf-8'))
    data['data'] = {
        "book": api_resp1['data'],
        "clothe": api_resp2['data'],
        "electronic": api_resp3['data'],
        "shoe": api_resp4['data'],
    }
